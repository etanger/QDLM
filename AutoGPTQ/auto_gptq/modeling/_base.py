...
class BaseGPTQForCausalLM(nn.Module, PushToHubMixin):
    ...
    def quantize(
        ...
        def store_input_hook(_, args, kwargs):
            ...
            # Keyword arguments.
            # if kwargs.get("attention_mask", None) and kwargs["attention_mask"] is not None:
            if "attention_mask" in kwargs and kwargs["attention_mask"] is not None and 'dream' not in self.model.__class__.__name__.lower():
    ...
    def from_pretrained(
        ...
        **model_init_kwargs,
        ...
        try:
            ...
            model = AutoModel.from_pretrained(pretrained_model_name_or_path, **merged_kwargs)
